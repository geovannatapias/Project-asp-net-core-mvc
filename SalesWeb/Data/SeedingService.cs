...
namespace SalesWeb.Data
{
    public class SeedingService
    {
        ...
        {
            _context = context; //injeção de dependencia salesweb (quando um seeding service for criado automaticamente recebe instancia do context)  
        }
        public void Seed() //popular base de dado
        {
            if (_context.Department.Any() || _context.Seller.Any() || _context.SalesRecord.Any()) //any verif se existe algum registro na tabela 
            {
            ...
            _context.Department.AddRange(d1, d2, d3, d4); //add range o objeto vai para o banco de dados 
